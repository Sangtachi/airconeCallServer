...
const memory_orders_repository_1 = require("./memory-orders.repository");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            ...
            extra_quotes_service_1.ExtraQuotesService,
            {
                ...
                useFactory: (sb) => sb ? new supabase_orders_repository_1.SupabaseOrdersRepository(sb) : new memory_orders_repository_1.MemoryOrdersRepository(),
